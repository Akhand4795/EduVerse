...
const Blog = () => {
  return (
    <div className="flex bg-grey overflow-hidden">
      <div className="flex flex-col w-2/3 h-full border-r-2 border-gray-400 overflow-y-auto">
        <div className="flex w-full justify-center">
          <Category />
        </div>
        <div className="flex w-full mb-4 justify-center">
          <div className="flex w-4/5 border-b-2 border-gray-400">
            <div className="flex flex-col w-3/4">
              <div className="flex p-4 items-center">
                <span className="mr-4">
                  <AccountCircle sx={{ fontSize: 40 }} className="" />
                </span>
                <span className="mr-4 align-middle">Tony Stark</span>
                <span className="mr-4">
                  <FiberManualRecord sx={{ fontSize: 12 }} />
                </span>
                <span className="mr-4">Updated 2h ago</span>
              </div>
              ...
              <div className="flex justify-between px-4 py-2">
                <div className="flex">
                  <button className="bg-yellow p-2 rounded-full text-center mr-4">
                    Carrer Advice
                  </button>
                  <span className="mr-4 pt-2">Time Read</span>
                  <span className="mr-4 pt-2">
                    <FiberManualRecord sx={{ fontSize: 12 }} />
                  </span>
                  <span className="mr-4 pt-2">Selected for you</span>
                </div>
                <div className="flex">
                  <span className="mr-4 pt-2">
                    <Comment />
